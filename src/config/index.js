const DEFAULT_CONFIG = {
	...
	PREDEFINE_THEMES: [
		...
		{ name: "暗夜黑", primary: "#1f1f1f", secondary: "#52525b", accent: "#18181b", surface: "#2b2b2b", background: "#141414", error: "#ef4444", onPrimary: "#ffffff", onSecondary: "#ffffff", gradient: "linear-gradient(135deg, #1f1f1f 0%, #141414 100%)", description: "极简黑色系", isCustom: false },
	],
