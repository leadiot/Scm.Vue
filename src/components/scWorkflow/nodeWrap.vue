<template>
	<promoter v-if="nodeConfig.type == 1" v-model="nodeConfig"></promoter>

	<approver v-if="nodeConfig.type == 2" v-model="nodeConfig"></approver>

	<send v-if="nodeConfig.type == 3" v-model="nodeConfig"></send>
